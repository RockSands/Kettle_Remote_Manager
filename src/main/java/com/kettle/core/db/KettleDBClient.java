...
public class KettleDBClient {
    ...
    // * @throws KettleException
    // */
    // public List<KettleRecordRelation> queryDependents(String mainJobUUID) throws
    // KettleException {
    // String sql = "SELECT " + KettleVariables.R_RECORD_DEPENDENT_MASTER_UUID_ID +
    // ","
    // + KettleVariables.R_RECORD_DEPENDENT_META_ID + "," +
    // KettleVariables.R_RECORD_DEPENDENT_META_TYPE
